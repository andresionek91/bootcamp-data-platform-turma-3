...
class SpectrumRole(iam.Role):
    def __init__(
        self, scope: core.Construct, data_lake_raw: BaseDataLakeBucket, **kwargs
    ) -> None:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.redshift_sg.add_ingress_rule(
            peer=ec2.Peer.ipv4("37.156.75.55/32"), connection=ec2.Port.tcp(5439)
        )
        ...
        self.redshift_cluster = redshift.Cluster(
            ...
            roles=[SpectrumRole(self, self.data_lake_raw)],
